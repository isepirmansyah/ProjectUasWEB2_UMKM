...
<div class="content">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <img src="<?= base_url('doc_tem2/images/logorounded.png'); ?>" alt="Image" class="img-fluid">
            </div>
            <div class="col-md-6 contents ">
                <div class="row justify-content-center">
                    <div class="col-md-8 shadow rounded bg-body p-4">
                        <div class="mb-4">
                            <h3>Sign In</h3>
                            <p class="mb-4">we will keep your account safe.</p>
                        </div>
                        <form action="<?= base_url("/login/proseslog"); ?>" method="post">
